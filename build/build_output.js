...
function PEG_codegen_5(tree){
 ...
 function f(n,ancestors){var ctx,i,l
  ...
  if(c5(ctx)){
   lazyAttr(n,"code_v5",function(b0,b1){return function(){return function(opts,drop){return codegen_v5(opts,b0.filter(function(b){return b[1]=="D"}).map(function(b){return b[0].nm()}),b1.filter(function(b){return b[1]=="D"}).map(function(b){return b[0].named_re()}))}}}(ctx.bindings[1],ctx.bindings[1]))}
  ctx=new BindingContext(n,ancestors)
  if(c9(ctx)){
...
Array.prototype.uniq=function(){
 return this.filter(function(e,i,a){return !i||e!==a[i-1]})}
