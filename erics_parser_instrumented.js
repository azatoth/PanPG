// this should run in both node/V8 (i.e. "$ node erics_parser.js") and the spidermonkey shell ("$ js < erics_parser.js")

if (typeof require=='function') var print = require('sys').puts

function Program(str){
 var tbl=[],pos=0,l=str.length+1;while(l--)tbl.push([]);l=str.length;
 function Program(a){print("Program");var x,p=pos,c;if(x=tbl[p][0]){pos=x[1];a.push([p,0]);return 1}if(x==false){return 0}c=[];return fin(c,p,0,_Program(c),a)}
 function FunctionBody(a){print("FunctionBody");var x,p=pos,c;if(x=tbl[p][1]){pos=x[1];a.push([p,1]);return 1}if(x==false){return 0}c=[];return fin(c,p,1,_FunctionBody(c),a)}
 function FunctionDeclaration(a){print("FunctionDeclaration");var x,p=pos,c;if(x=tbl[p][2]){pos=x[1];a.push([p,2]);return 1}if(x==false){return 0}c=[];return fin(c,p,2,_FunctionDeclaration(c),a)}
 function FunctionExpr(a){print("FunctionExpr");var x,p=pos,c;if(x=tbl[p][3]){pos=x[1];a.push([p,3]);return 1}if(x==false){return 0}c=[];return fin(c,p,3,_FunctionExpr(c),a)}
 function FormalParameterList(a){print("FormalParameterList");var x,p=pos,c;if(x=tbl[p][4]){pos=x[1];a.push([p,4]);return 1}if(x==false){return 0}c=[];return fin(c,p,4,_FormalParameterList(c),a)}
 function UseStrictDirective(a){print("UseStrictDirective");var x,p=pos,c;if(x=tbl[p][5]){pos=x[1];a.push([p,5]);return 1}if(x==false){return 0}c=[];return fin(c,p,5,_UseStrictDirective(c),a)}
 function Statement(a){print("Statement");var x,p=pos,c;if(x=tbl[p][6]){pos=x[1];a.push([p,6]);return 1}if(x==false){return 0}c=[];return fin(c,p,6,_Statement(c),a)}
 function Block(a){print("Block");var x,p=pos,c;if(x=tbl[p][7]){pos=x[1];a.push([p,7]);return 1}if(x==false){return 0}c=[];return fin(c,p,7,_Block(c),a)}
 function VariableStatement(a){print("VariableStatement");var x,p=pos,c;if(x=tbl[p][8]){pos=x[1];a.push([p,8]);return 1}if(x==false){return 0}c=[];return fin(c,p,8,_VariableStatement(c),a)}
 function VariableDeclarationListNoIn(a){print("VariableDeclarationListNoIn");var x,p=pos,c;if(x=tbl[p][9]){pos=x[1];a.push([p,9]);return 1}if(x==false){return 0}c=[];return fin(c,p,9,_VariableDeclarationListNoIn(c),a)}
 function VariableDeclaration(a){print("VariableDeclaration");var x,p=pos,c;if(x=tbl[p][10]){pos=x[1];a.push([p,10]);return 1}if(x==false){return 0}c=[];return fin(c,p,10,_VariableDeclaration(c),a)}
 function VariableDeclarationNoIn(a){print("VariableDeclarationNoIn");var x,p=pos,c;if(x=tbl[p][11]){pos=x[1];a.push([p,11]);return 1}if(x==false){return 0}c=[];return fin(c,p,11,_VariableDeclarationNoIn(c),a)}
 function EmptyStatement(a){print("EmptyStatement");var x,p=pos,c;if(x=tbl[p][12]){pos=x[1];a.push([p,12]);return 1}if(x==false){return 0}c=[];return fin(c,p,12,_EmptyStatement(c),a)}
 function ExprStatement(a){print("ExprStatement");var x,p=pos,c;if(x=tbl[p][13]){pos=x[1];a.push([p,13]);return 1}if(x==false){return 0}c=[];return fin(c,p,13,_ExprStatement(c),a)}
 function IfStatement(a){print("IfStatement");var x,p=pos,c;if(x=tbl[p][14]){pos=x[1];a.push([p,14]);return 1}if(x==false){return 0}c=[];return fin(c,p,14,_IfStatement(c),a)}
 function IterationStatement(a){print("IterationStatement");var x,p=pos,c;if(x=tbl[p][15]){pos=x[1];a.push([p,15]);return 1}if(x==false){return 0}c=[];return fin(c,p,15,_IterationStatement(c),a)}
 function DoWhileStatement(a){print("DoWhileStatement");var x,p=pos,c;if(x=tbl[p][16]){pos=x[1];a.push([p,16]);return 1}if(x==false){return 0}c=[];return fin(c,p,16,_DoWhileStatement(c),a)}
 function WhileStatement(a){print("WhileStatement");var x,p=pos,c;if(x=tbl[p][17]){pos=x[1];a.push([p,17]);return 1}if(x==false){return 0}c=[];return fin(c,p,17,_WhileStatement(c),a)}
 function ForInStatement(a){print("ForInStatement");var x,p=pos,c;if(x=tbl[p][18]){pos=x[1];a.push([p,18]);return 1}if(x==false){return 0}c=[];return fin(c,p,18,_ForInStatement(c),a)}
 function ForStatement(a){print("ForStatement");var x,p=pos,c;if(x=tbl[p][19]){pos=x[1];a.push([p,19]);return 1}if(x==false){return 0}c=[];return fin(c,p,19,_ForStatement(c),a)}
 function ContinueStatement(a){print("ContinueStatement");var x,p=pos,c;if(x=tbl[p][20]){pos=x[1];a.push([p,20]);return 1}if(x==false){return 0}c=[];return fin(c,p,20,_ContinueStatement(c),a)}
 function BreakStatement(a){print("BreakStatement");var x,p=pos,c;if(x=tbl[p][21]){pos=x[1];a.push([p,21]);return 1}if(x==false){return 0}c=[];return fin(c,p,21,_BreakStatement(c),a)}
 function ReturnStatement(a){print("ReturnStatement");var x,p=pos,c;if(x=tbl[p][22]){pos=x[1];a.push([p,22]);return 1}if(x==false){return 0}c=[];return fin(c,p,22,_ReturnStatement(c),a)}
 function WithStatement(a){print("WithStatement");var x,p=pos,c;if(x=tbl[p][23]){pos=x[1];a.push([p,23]);return 1}if(x==false){return 0}c=[];return fin(c,p,23,_WithStatement(c),a)}
 function LabelledStatement(a){print("LabelledStatement");var x,p=pos,c;if(x=tbl[p][24]){pos=x[1];a.push([p,24]);return 1}if(x==false){return 0}c=[];return fin(c,p,24,_LabelledStatement(c),a)}
 function SwitchStatement(a){print("SwitchStatement");var x,p=pos,c;if(x=tbl[p][25]){pos=x[1];a.push([p,25]);return 1}if(x==false){return 0}c=[];return fin(c,p,25,_SwitchStatement(c),a)}
 function CaseClause(a){print("CaseClause");var x,p=pos,c;if(x=tbl[p][26]){pos=x[1];a.push([p,26]);return 1}if(x==false){return 0}c=[];return fin(c,p,26,_CaseClause(c),a)}
 function DefaultClause(a){print("DefaultClause");var x,p=pos,c;if(x=tbl[p][27]){pos=x[1];a.push([p,27]);return 1}if(x==false){return 0}c=[];return fin(c,p,27,_DefaultClause(c),a)}
 function ThrowStatement(a){print("ThrowStatement");var x,p=pos,c;if(x=tbl[p][28]){pos=x[1];a.push([p,28]);return 1}if(x==false){return 0}c=[];return fin(c,p,28,_ThrowStatement(c),a)}
 function TryStatement(a){print("TryStatement");var x,p=pos,c;if(x=tbl[p][29]){pos=x[1];a.push([p,29]);return 1}if(x==false){return 0}c=[];return fin(c,p,29,_TryStatement(c),a)}
 function Catch(a){print("Catch");var x,p=pos,c;if(x=tbl[p][30]){pos=x[1];a.push([p,30]);return 1}if(x==false){return 0}c=[];return fin(c,p,30,_Catch(c),a)}
 function Finally(a){print("Finally");var x,p=pos,c;if(x=tbl[p][31]){pos=x[1];a.push([p,31]);return 1}if(x==false){return 0}c=[];return fin(c,p,31,_Finally(c),a)}
 function DebuggerStatement(a){print("DebuggerStatement");var x,p=pos,c;if(x=tbl[p][32]){pos=x[1];a.push([p,32]);return 1}if(x==false){return 0}c=[];return fin(c,p,32,_DebuggerStatement(c),a)}
 function Expr(a){print("Expr");var x,p=pos,c;if(x=tbl[p][33]){pos=x[1];a.push([p,33]);return 1}if(x==false){return 0}c=[];return fin(c,p,33,_Expr(c),a)}
 function ExprNoIn(a){print("ExprNoIn");var x,p=pos,c;if(x=tbl[p][34]){pos=x[1];a.push([p,34]);return 1}if(x==false){return 0}c=[];return fin(c,p,34,_ExprNoIn(c),a)}
 function AssignmentExpr(a){print("AssignmentExpr");var x,p=pos,c;if(x=tbl[p][35]){pos=x[1];a.push([p,35]);return 1}if(x==false){return 0}c=[];return fin(c,p,35,_AssignmentExpr(c),a)}
 function AssignmentExprNoIn(a){print("AssignmentExprNoIn");var x,p=pos,c;if(x=tbl[p][36]){pos=x[1];a.push([p,36]);return 1}if(x==false){return 0}c=[];return fin(c,p,36,_AssignmentExprNoIn(c),a)}
 function AssignmentOperator(a){print("AssignmentOperator");var x,p=pos,c;if(x=tbl[p][37]){pos=x[1];a.push([p,37]);return 1}if(x==false){return 0}c=[];return fin(c,p,37,_AssignmentOperator(c),a)}
 function ConditionalExpr(a){print("ConditionalExpr");var x,p=pos,c;if(x=tbl[p][38]){pos=x[1];a.push([p,38]);return 1}if(x==false){return 0}c=[];return fin(c,p,38,_ConditionalExpr(c),a)}
 function ConditionalExprNoIn(a){print("ConditionalExprNoIn");var x,p=pos,c;if(x=tbl[p][39]){pos=x[1];a.push([p,39]);return 1}if(x==false){return 0}c=[];return fin(c,p,39,_ConditionalExprNoIn(c),a)}
 function LogicalOrExpr(a){print("LogicalOrExpr");var x,p=pos,c;if(x=tbl[p][40]){pos=x[1];a.push([p,40]);return 1}if(x==false){return 0}c=[];return fin(c,p,40,_LogicalOrExpr(c),a)}
 function LogicalOrExprNoIn(a){print("LogicalOrExprNoIn");var x,p=pos,c;if(x=tbl[p][41]){pos=x[1];a.push([p,41]);return 1}if(x==false){return 0}c=[];return fin(c,p,41,_LogicalOrExprNoIn(c),a)}
 function LogicalAndExpr(a){print("LogicalAndExpr");var x,p=pos,c;if(x=tbl[p][42]){pos=x[1];a.push([p,42]);return 1}if(x==false){return 0}c=[];return fin(c,p,42,_LogicalAndExpr(c),a)}
 function LogicalAndExprNoIn(a){print("LogicalAndExprNoIn");var x,p=pos,c;if(x=tbl[p][43]){pos=x[1];a.push([p,43]);return 1}if(x==false){return 0}c=[];return fin(c,p,43,_LogicalAndExprNoIn(c),a)}
 function BitwiseOrExpr(a){print("BitwiseOrExpr");var x,p=pos,c;if(x=tbl[p][44]){pos=x[1];a.push([p,44]);return 1}if(x==false){return 0}c=[];return fin(c,p,44,_BitwiseOrExpr(c),a)}
 function BitwiseOrExprNoIn(a){print("BitwiseOrExprNoIn");var x,p=pos,c;if(x=tbl[p][45]){pos=x[1];a.push([p,45]);return 1}if(x==false){return 0}c=[];return fin(c,p,45,_BitwiseOrExprNoIn(c),a)}
 function BitwiseXOrExpr(a){print("BitwiseXOrExpr");var x,p=pos,c;if(x=tbl[p][46]){pos=x[1];a.push([p,46]);return 1}if(x==false){return 0}c=[];return fin(c,p,46,_BitwiseXOrExpr(c),a)}
 function BitwiseXOrExprNoIn(a){print("BitwiseXOrExprNoIn");var x,p=pos,c;if(x=tbl[p][47]){pos=x[1];a.push([p,47]);return 1}if(x==false){return 0}c=[];return fin(c,p,47,_BitwiseXOrExprNoIn(c),a)}
 function BitwiseAndExpr(a){print("BitwiseAndExpr");var x,p=pos,c;if(x=tbl[p][48]){pos=x[1];a.push([p,48]);return 1}if(x==false){return 0}c=[];return fin(c,p,48,_BitwiseAndExpr(c),a)}
 function BitwiseAndExprNoIn(a){print("BitwiseAndExprNoIn");var x,p=pos,c;if(x=tbl[p][49]){pos=x[1];a.push([p,49]);return 1}if(x==false){return 0}c=[];return fin(c,p,49,_BitwiseAndExprNoIn(c),a)}
 function EqualityExpr(a){print("EqualityExpr");var x,p=pos,c;if(x=tbl[p][50]){pos=x[1];a.push([p,50]);return 1}if(x==false){return 0}c=[];return fin(c,p,50,_EqualityExpr(c),a)}
 function EqualityExprNoIn(a){print("EqualityExprNoIn");var x,p=pos,c;if(x=tbl[p][51]){pos=x[1];a.push([p,51]);return 1}if(x==false){return 0}c=[];return fin(c,p,51,_EqualityExprNoIn(c),a)}
 function EqualityOp(a){print("EqualityOp");var x,p=pos,c;if(x=tbl[p][52]){pos=x[1];a.push([p,52]);return 1}if(x==false){return 0}c=[];return fin(c,p,52,_EqualityOp(c),a)}
 function RelationalExpr(a){print("RelationalExpr");var x,p=pos,c;if(x=tbl[p][53]){pos=x[1];a.push([p,53]);return 1}if(x==false){return 0}c=[];return fin(c,p,53,_RelationalExpr(c),a)}
 function RelationalExprNoIn(a){print("RelationalExprNoIn");var x,p=pos,c;if(x=tbl[p][54]){pos=x[1];a.push([p,54]);return 1}if(x==false){return 0}c=[];return fin(c,p,54,_RelationalExprNoIn(c),a)}
 function RelationalOp(a){print("RelationalOp");var x,p=pos,c;if(x=tbl[p][55]){pos=x[1];a.push([p,55]);return 1}if(x==false){return 0}c=[];return fin(c,p,55,_RelationalOp(c),a)}
 function RelationalOpNoIn(a){print("RelationalOpNoIn");var x,p=pos,c;if(x=tbl[p][56]){pos=x[1];a.push([p,56]);return 1}if(x==false){return 0}c=[];return fin(c,p,56,_RelationalOpNoIn(c),a)}
 function ShiftExpr(a){print("ShiftExpr");var x,p=pos,c;if(x=tbl[p][57]){pos=x[1];a.push([p,57]);return 1}if(x==false){return 0}c=[];return fin(c,p,57,_ShiftExpr(c),a)}
 function ShiftOp(a){print("ShiftOp");var x,p=pos,c;if(x=tbl[p][58]){pos=x[1];a.push([p,58]);return 1}if(x==false){return 0}c=[];return fin(c,p,58,_ShiftOp(c),a)}
 function AdditiveExpr(a){print("AdditiveExpr");var x,p=pos,c;if(x=tbl[p][59]){pos=x[1];a.push([p,59]);return 1}if(x==false){return 0}c=[];return fin(c,p,59,_AdditiveExpr(c),a)}
 function AdditiveOp(a){print("AdditiveOp");var x,p=pos,c;if(x=tbl[p][60]){pos=x[1];a.push([p,60]);return 1}if(x==false){return 0}c=[];return fin(c,p,60,_AdditiveOp(c),a)}
 function MultiplicativeExpr(a){print("MultiplicativeExpr");var x,p=pos,c;if(x=tbl[p][61]){pos=x[1];a.push([p,61]);return 1}if(x==false){return 0}c=[];return fin(c,p,61,_MultiplicativeExpr(c),a)}
 function MultiplicativeOp(a){print("MultiplicativeOp");var x,p=pos,c;if(x=tbl[p][62]){pos=x[1];a.push([p,62]);return 1}if(x==false){return 0}c=[];return fin(c,p,62,_MultiplicativeOp(c),a)}
 function UnaryExpr(a){print("UnaryExpr");var x,p=pos,c;if(x=tbl[p][63]){pos=x[1];a.push([p,63]);return 1}if(x==false){return 0}c=[];return fin(c,p,63,_UnaryExpr(c),a)}
 function PostfixExpr(a){print("PostfixExpr");var x,p=pos,c;if(x=tbl[p][64]){pos=x[1];a.push([p,64]);return 1}if(x==false){return 0}c=[];return fin(c,p,64,_PostfixExpr(c),a)}
 function LeftHandSideExpr(a){print("LeftHandSideExpr");var x,p=pos,c;if(x=tbl[p][65]){pos=x[1];a.push([p,65]);return 1}if(x==false){return 0}c=[];return fin(c,p,65,_LeftHandSideExpr(c),a)}
 function CallExpr(a){print("CallExpr");var x,p=pos,c;if(x=tbl[p][66]){pos=x[1];a.push([p,66]);return 1}if(x==false){return 0}c=[];return fin(c,p,66,_CallExpr(c),a)}
 function Arguments(a){print("Arguments");var x,p=pos,c;if(x=tbl[p][67]){pos=x[1];a.push([p,67]);return 1}if(x==false){return 0}c=[];return fin(c,p,67,_Arguments(c),a)}
 function ArgumentList(a){print("ArgumentList");var x,p=pos,c;if(x=tbl[p][68]){pos=x[1];a.push([p,68]);return 1}if(x==false){return 0}c=[];return fin(c,p,68,_ArgumentList(c),a)}
 function NewExpr(a){print("NewExpr");var x,p=pos,c;if(x=tbl[p][69]){pos=x[1];a.push([p,69]);return 1}if(x==false){return 0}c=[];return fin(c,p,69,_NewExpr(c),a)}
 function MemberExpr(a){print("MemberExpr");var x,p=pos,c;if(x=tbl[p][70]){pos=x[1];a.push([p,70]);return 1}if(x==false){return 0}c=[];return fin(c,p,70,_MemberExpr(c),a)}
 function PrimaryExpr(a){print("PrimaryExpr");var x,p=pos,c;if(x=tbl[p][71]){pos=x[1];a.push([p,71]);return 1}if(x==false){return 0}c=[];return fin(c,p,71,_PrimaryExpr(c),a)}
 function ArrayLiteral(a){print("ArrayLiteral");var x,p=pos,c;if(x=tbl[p][72]){pos=x[1];a.push([p,72]);return 1}if(x==false){return 0}c=[];return fin(c,p,72,_ArrayLiteral(c),a)}
 function ElementList(a){print("ElementList");var x,p=pos,c;if(x=tbl[p][73]){pos=x[1];a.push([p,73]);return 1}if(x==false){return 0}c=[];return fin(c,p,73,_ElementList(c),a)}
 function Elision(a){print("Elision");var x,p=pos,c;if(x=tbl[p][74]){pos=x[1];a.push([p,74]);return 1}if(x==false){return 0}c=[];return fin(c,p,74,_Elision(c),a)}
 function ObjectLiteral(a){print("ObjectLiteral");var x,p=pos,c;if(x=tbl[p][75]){pos=x[1];a.push([p,75]);return 1}if(x==false){return 0}c=[];return fin(c,p,75,_ObjectLiteral(c),a)}
 function PropertyNameAndValueList(a){print("PropertyNameAndValueList");var x,p=pos,c;if(x=tbl[p][76]){pos=x[1];a.push([p,76]);return 1}if(x==false){return 0}c=[];return fin(c,p,76,_PropertyNameAndValueList(c),a)}
 function PropertyAssignment(a){print("PropertyAssignment");var x,p=pos,c;if(x=tbl[p][77]){pos=x[1];a.push([p,77]);return 1}if(x==false){return 0}c=[];return fin(c,p,77,_PropertyAssignment(c),a)}
 function PropertyName(a){print("PropertyName");var x,p=pos,c;if(x=tbl[p][78]){pos=x[1];a.push([p,78]);return 1}if(x==false){return 0}c=[];return fin(c,p,78,_PropertyName(c),a)}
 function PropertySetParameterList(a){print("PropertySetParameterList");var x,p=pos,c;if(x=tbl[p][79]){pos=x[1];a.push([p,79]);return 1}if(x==false){return 0}c=[];return fin(c,p,79,_PropertySetParameterList(c),a)}
 function Literal(a){print("Literal");var x,p=pos,c;if(x=tbl[p][80]){pos=x[1];a.push([p,80]);return 1}if(x==false){return 0}c=[];return fin(c,p,80,_Literal(c),a)}
 function NullLiteral(a){print("NullLiteral");var x,p=pos,c;if(x=tbl[p][81]){pos=x[1];a.push([p,81]);return 1}if(x==false){return 0}c=[];return fin(c,p,81,_NullLiteral(c),a)}
 function BooleanLiteral(a){print("BooleanLiteral");var x,p=pos,c;if(x=tbl[p][82]){pos=x[1];a.push([p,82]);return 1}if(x==false){return 0}c=[];return fin(c,p,82,_BooleanLiteral(c),a)}
 function NumericLiteral(a){print("NumericLiteral");var x,p=pos,c;if(x=tbl[p][83]){pos=x[1];a.push([p,83]);return 1}if(x==false){return 0}c=[];return fin(c,p,83,_NumericLiteral(c),a)}
 function DecimalLiteral(a){print("DecimalLiteral");var x,p=pos,c;if(x=tbl[p][84]){pos=x[1];a.push([p,84]);return 1}if(x==false){return 0}c=[];return fin(c,p,84,_DecimalLiteral(c),a)}
 function DecimalIntegerLiteral(a){print("DecimalIntegerLiteral");var x,p=pos,c;if(x=tbl[p][85]){pos=x[1];a.push([p,85]);return 1}if(x==false){return 0}c=[];return fin(c,p,85,_DecimalIntegerLiteral(c),a)}
 function DecimalDigit(a){print("DecimalDigit");var x,p=pos,c;if(x=tbl[p][86]){pos=x[1];a.push([p,86]);return 1}if(x==false){return 0}c=[];return fin(c,p,86,_DecimalDigit(c),a)}
 function ExponentPart(a){print("ExponentPart");var x,p=pos,c;if(x=tbl[p][87]){pos=x[1];a.push([p,87]);return 1}if(x==false){return 0}c=[];return fin(c,p,87,_ExponentPart(c),a)}
 function SignedInteger(a){print("SignedInteger");var x,p=pos,c;if(x=tbl[p][88]){pos=x[1];a.push([p,88]);return 1}if(x==false){return 0}c=[];return fin(c,p,88,_SignedInteger(c),a)}
 function HexIntegerLiteral(a){print("HexIntegerLiteral");var x,p=pos,c;if(x=tbl[p][89]){pos=x[1];a.push([p,89]);return 1}if(x==false){return 0}c=[];return fin(c,p,89,_HexIntegerLiteral(c),a)}
 function DQ(a){print("DQ");var x,p=pos,c;if(x=tbl[p][90]){pos=x[1];a.push([p,90]);return 1}if(x==false){return 0}c=[];return fin(c,p,90,_DQ(c),a)}
 function SQ(a){print("SQ");var x,p=pos,c;if(x=tbl[p][91]){pos=x[1];a.push([p,91]);return 1}if(x==false){return 0}c=[];return fin(c,p,91,_SQ(c),a)}
 function StringLiteral(a){print("StringLiteral");var x,p=pos,c;if(x=tbl[p][92]){pos=x[1];a.push([p,92]);return 1}if(x==false){return 0}c=[];return fin(c,p,92,_StringLiteral(c),a)}
 function RS(a){print("RS");var x,p=pos,c;if(x=tbl[p][93]){pos=x[1];a.push([p,93]);return 1}if(x==false){return 0}c=[];return fin(c,p,93,_RS(c),a)}
 function DoubleStringCharacter(a){print("DoubleStringCharacter");var x,p=pos,c;if(x=tbl[p][94]){pos=x[1];a.push([p,94]);return 1}if(x==false){return 0}c=[];return fin(c,p,94,_DoubleStringCharacter(c),a)}
 function SingleStringCharacter(a){print("SingleStringCharacter");var x,p=pos,c;if(x=tbl[p][95]){pos=x[1];a.push([p,95]);return 1}if(x==false){return 0}c=[];return fin(c,p,95,_SingleStringCharacter(c),a)}
 function LineContinuation(a){print("LineContinuation");var x,p=pos,c;if(x=tbl[p][96]){pos=x[1];a.push([p,96]);return 1}if(x==false){return 0}c=[];return fin(c,p,96,_LineContinuation(c),a)}
 function EscapeSequence(a){print("EscapeSequence");var x,p=pos,c;if(x=tbl[p][97]){pos=x[1];a.push([p,97]);return 1}if(x==false){return 0}c=[];return fin(c,p,97,_EscapeSequence(c),a)}
 function CharacterEscapeSequence(a){print("CharacterEscapeSequence");var x,p=pos,c;if(x=tbl[p][98]){pos=x[1];a.push([p,98]);return 1}if(x==false){return 0}c=[];return fin(c,p,98,_CharacterEscapeSequence(c),a)}
 function SingleEscapeCharacter(a){print("SingleEscapeCharacter");var x,p=pos,c;if(x=tbl[p][99]){pos=x[1];a.push([p,99]);return 1}if(x==false){return 0}c=[];return fin(c,p,99,_SingleEscapeCharacter(c),a)}
 function NonEscapeCharacter(a){print("NonEscapeCharacter");var x,p=pos,c;if(x=tbl[p][100]){pos=x[1];a.push([p,100]);return 1}if(x==false){return 0}c=[];return fin(c,p,100,_NonEscapeCharacter(c),a)}
 function EscapeCharacter(a){print("EscapeCharacter");var x,p=pos,c;if(x=tbl[p][101]){pos=x[1];a.push([p,101]);return 1}if(x==false){return 0}c=[];return fin(c,p,101,_EscapeCharacter(c),a)}
 function HexEscapeSequence(a){print("HexEscapeSequence");var x,p=pos,c;if(x=tbl[p][102]){pos=x[1];a.push([p,102]);return 1}if(x==false){return 0}c=[];return fin(c,p,102,_HexEscapeSequence(c),a)}
 function UnicodeEscapeSequence(a){print("UnicodeEscapeSequence");var x,p=pos,c;if(x=tbl[p][103]){pos=x[1];a.push([p,103]);return 1}if(x==false){return 0}c=[];return fin(c,p,103,_UnicodeEscapeSequence(c),a)}
 function RegularExpressionLiteral(a){print("RegularExpressionLiteral");var x,p=pos,c;if(x=tbl[p][104]){pos=x[1];a.push([p,104]);return 1}if(x==false){return 0}c=[];return fin(c,p,104,_RegularExpressionLiteral(c),a)}
 function RegularExpressionBody(a){print("RegularExpressionBody");var x,p=pos,c;if(x=tbl[p][105]){pos=x[1];a.push([p,105]);return 1}if(x==false){return 0}c=[];return fin(c,p,105,_RegularExpressionBody(c),a)}
 function RegularExpressionFirstChar(a){print("RegularExpressionFirstChar");var x,p=pos,c;if(x=tbl[p][106]){pos=x[1];a.push([p,106]);return 1}if(x==false){return 0}c=[];return fin(c,p,106,_RegularExpressionFirstChar(c),a)}
 function RegularExpressionChar(a){print("RegularExpressionChar");var x,p=pos,c;if(x=tbl[p][107]){pos=x[1];a.push([p,107]);return 1}if(x==false){return 0}c=[];return fin(c,p,107,_RegularExpressionChar(c),a)}
 function RegularExpressionBackslashSequence(a){print("RegularExpressionBackslashSequence");var x,p=pos,c;if(x=tbl[p][108]){pos=x[1];a.push([p,108]);return 1}if(x==false){return 0}c=[];return fin(c,p,108,_RegularExpressionBackslashSequence(c),a)}
 function RegularExpressionClass(a){print("RegularExpressionClass");var x,p=pos,c;if(x=tbl[p][109]){pos=x[1];a.push([p,109]);return 1}if(x==false){return 0}c=[];return fin(c,p,109,_RegularExpressionClass(c),a)}
 function RegularExpressionClassChar(a){print("RegularExpressionClassChar");var x,p=pos,c;if(x=tbl[p][110]){pos=x[1];a.push([p,110]);return 1}if(x==false){return 0}c=[];return fin(c,p,110,_RegularExpressionClassChar(c),a)}
 function RegularExpressionFlags(a){print("RegularExpressionFlags");var x,p=pos,c;if(x=tbl[p][111]){pos=x[1];a.push([p,111]);return 1}if(x==false){return 0}c=[];return fin(c,p,111,_RegularExpressionFlags(c),a)}
 function SourceCharacter(a){print("SourceCharacter");var x,p=pos,c;if(x=tbl[p][112]){pos=x[1];a.push([p,112]);return 1}if(x==false){return 0}c=[];return fin(c,p,112,_SourceCharacter(c),a)}
 function WhiteSpace(a){print("WhiteSpace");var x,p=pos,c;if(x=tbl[p][113]){pos=x[1];a.push([p,113]);return 1}if(x==false){return 0}c=[];return fin(c,p,113,_WhiteSpace(c),a)}
 function LF(a){print("LF");var x,p=pos,c;if(x=tbl[p][114]){pos=x[1];a.push([p,114]);return 1}if(x==false){return 0}c=[];return fin(c,p,114,_LF(c),a)}
 function CR(a){print("CR");var x,p=pos,c;if(x=tbl[p][115]){pos=x[1];a.push([p,115]);return 1}if(x==false){return 0}c=[];return fin(c,p,115,_CR(c),a)}
 function LS(a){print("LS");var x,p=pos,c;if(x=tbl[p][116]){pos=x[1];a.push([p,116]);return 1}if(x==false){return 0}c=[];return fin(c,p,116,_LS(c),a)}
 function PS(a){print("PS");var x,p=pos,c;if(x=tbl[p][117]){pos=x[1];a.push([p,117]);return 1}if(x==false){return 0}c=[];return fin(c,p,117,_PS(c),a)}
 function LineTerminator(a){print("LineTerminator");var x,p=pos,c;if(x=tbl[p][118]){pos=x[1];a.push([p,118]);return 1}if(x==false){return 0}c=[];return fin(c,p,118,_LineTerminator(c),a)}
 function LineTerminatorSequence(a){print("LineTerminatorSequence");var x,p=pos,c;if(x=tbl[p][119]){pos=x[1];a.push([p,119]);return 1}if(x==false){return 0}c=[];return fin(c,p,119,_LineTerminatorSequence(c),a)}
 function Comment(a){print("Comment");var x,p=pos,c;if(x=tbl[p][120]){pos=x[1];a.push([p,120]);return 1}if(x==false){return 0}c=[];return fin(c,p,120,_Comment(c),a)}
 function MultiLineComment(a){print("MultiLineComment");var x,p=pos,c;if(x=tbl[p][121]){pos=x[1];a.push([p,121]);return 1}if(x==false){return 0}c=[];return fin(c,p,121,_MultiLineComment(c),a)}
 function MultiLineCommentNoLB(a){print("MultiLineCommentNoLB");var x,p=pos,c;if(x=tbl[p][122]){pos=x[1];a.push([p,122]);return 1}if(x==false){return 0}c=[];return fin(c,p,122,_MultiLineCommentNoLB(c),a)}
 function SingleLineComment(a){print("SingleLineComment");var x,p=pos,c;if(x=tbl[p][123]){pos=x[1];a.push([p,123]);return 1}if(x==false){return 0}c=[];return fin(c,p,123,_SingleLineComment(c),a)}
 function S(a){print("S");var x,p=pos,c;if(x=tbl[p][124]){pos=x[1];a.push([p,124]);return 1}if(x==false){return 0}c=[];return fin(c,p,124,_S(c),a)}
 function SnoLB(a){print("SnoLB");var x,p=pos,c;if(x=tbl[p][125]){pos=x[1];a.push([p,125]);return 1}if(x==false){return 0}c=[];return fin(c,p,125,_SnoLB(c),a)}
 function EOS(a){print("EOS");var x,p=pos,c;if(x=tbl[p][126]){pos=x[1];a.push([p,126]);return 1}if(x==false){return 0}c=[];return fin(c,p,126,_EOS(c),a)}
 function EOSnoLB(a){print("EOSnoLB");var x,p=pos,c;if(x=tbl[p][127]){pos=x[1];a.push([p,127]);return 1}if(x==false){return 0}c=[];return fin(c,p,127,_EOSnoLB(c),a)}
 function EOF(a){print("EOF");var x,p=pos,c;if(x=tbl[p][128]){pos=x[1];a.push([p,128]);return 1}if(x==false){return 0}c=[];return fin(c,p,128,_EOF(c),a)}
 function ReservedWord(a){print("ReservedWord");var x,p=pos,c;if(x=tbl[p][129]){pos=x[1];a.push([p,129]);return 1}if(x==false){return 0}c=[];return fin(c,p,129,_ReservedWord(c),a)}
 function Keyword(a){print("Keyword");var x,p=pos,c;if(x=tbl[p][130]){pos=x[1];a.push([p,130]);return 1}if(x==false){return 0}c=[];return fin(c,p,130,_Keyword(c),a)}
 function FutureReservedWord(a){print("FutureReservedWord");var x,p=pos,c;if(x=tbl[p][131]){pos=x[1];a.push([p,131]);return 1}if(x==false){return 0}c=[];return fin(c,p,131,_FutureReservedWord(c),a)}
 function Identifier(a){print("Identifier");var x,p=pos,c;if(x=tbl[p][132]){pos=x[1];a.push([p,132]);return 1}if(x==false){return 0}c=[];return fin(c,p,132,_Identifier(c),a)}
 function IdentifierName(a){print("IdentifierName");var x,p=pos,c;if(x=tbl[p][133]){pos=x[1];a.push([p,133]);return 1}if(x==false){return 0}c=[];return fin(c,p,133,_IdentifierName(c),a)}
 function IdentifierStart(a){print("IdentifierStart");var x,p=pos,c;if(x=tbl[p][134]){pos=x[1];a.push([p,134]);return 1}if(x==false){return 0}c=[];return fin(c,p,134,_IdentifierStart(c),a)}
 function IdentifierPart(a){print("IdentifierPart");var x,p=pos,c;if(x=tbl[p][135]){pos=x[1];a.push([p,135]);return 1}if(x==false){return 0}c=[];return fin(c,p,135,_IdentifierPart(c),a)}
 function UnicodeLetter(a){print("UnicodeLetter");var x,p=pos,c;if(x=tbl[p][136]){pos=x[1];a.push([p,136]);return 1}if(x==false){return 0}c=[];return fin(c,p,136,_UnicodeLetter(c),a)}
 function HexDigit(a){print("HexDigit");var x,p=pos,c;if(x=tbl[p][137]){pos=x[1];a.push([p,137]);return 1}if(x==false){return 0}c=[];return fin(c,p,137,_HexDigit(c),a)}
 function FalseTok(a){print("FalseTok");var x,p=pos,c;if(x=tbl[p][138]){pos=x[1];a.push([p,138]);return 1}if(x==false){return 0}c=[];return fin(c,p,138,_FalseTok(c),a)}
 function TrueTok(a){print("TrueTok");var x,p=pos,c;if(x=tbl[p][139]){pos=x[1];a.push([p,139]);return 1}if(x==false){return 0}c=[];return fin(c,p,139,_TrueTok(c),a)}
 function NullTok(a){print("NullTok");var x,p=pos,c;if(x=tbl[p][140]){pos=x[1];a.push([p,140]);return 1}if(x==false){return 0}c=[];return fin(c,p,140,_NullTok(c),a)}
 function BreakTok(a){print("BreakTok");var x,p=pos,c;if(x=tbl[p][141]){pos=x[1];a.push([p,141]);return 1}if(x==false){return 0}c=[];return fin(c,p,141,_BreakTok(c),a)}
 function ContinueTok(a){print("ContinueTok");var x,p=pos,c;if(x=tbl[p][142]){pos=x[1];a.push([p,142]);return 1}if(x==false){return 0}c=[];return fin(c,p,142,_ContinueTok(c),a)}
 function DebuggerTok(a){print("DebuggerTok");var x,p=pos,c;if(x=tbl[p][143]){pos=x[1];a.push([p,143]);return 1}if(x==false){return 0}c=[];return fin(c,p,143,_DebuggerTok(c),a)}
 function InTok(a){print("InTok");var x,p=pos,c;if(x=tbl[p][144]){pos=x[1];a.push([p,144]);return 1}if(x==false){return 0}c=[];return fin(c,p,144,_InTok(c),a)}
 function InstanceOfTok(a){print("InstanceOfTok");var x,p=pos,c;if(x=tbl[p][145]){pos=x[1];a.push([p,145]);return 1}if(x==false){return 0}c=[];return fin(c,p,145,_InstanceOfTok(c),a)}
 function DeleteTok(a){print("DeleteTok");var x,p=pos,c;if(x=tbl[p][146]){pos=x[1];a.push([p,146]);return 1}if(x==false){return 0}c=[];return fin(c,p,146,_DeleteTok(c),a)}
 function FunctionTok(a){print("FunctionTok");var x,p=pos,c;if(x=tbl[p][147]){pos=x[1];a.push([p,147]);return 1}if(x==false){return 0}c=[];return fin(c,p,147,_FunctionTok(c),a)}
 function NewTok(a){print("NewTok");var x,p=pos,c;if(x=tbl[p][148]){pos=x[1];a.push([p,148]);return 1}if(x==false){return 0}c=[];return fin(c,p,148,_NewTok(c),a)}
 function ThisTok(a){print("ThisTok");var x,p=pos,c;if(x=tbl[p][149]){pos=x[1];a.push([p,149]);return 1}if(x==false){return 0}c=[];return fin(c,p,149,_ThisTok(c),a)}
 function TypeofTok(a){print("TypeofTok");var x,p=pos,c;if(x=tbl[p][150]){pos=x[1];a.push([p,150]);return 1}if(x==false){return 0}c=[];return fin(c,p,150,_TypeofTok(c),a)}
 function VoidTok(a){print("VoidTok");var x,p=pos,c;if(x=tbl[p][151]){pos=x[1];a.push([p,151]);return 1}if(x==false){return 0}c=[];return fin(c,p,151,_VoidTok(c),a)}
 function IfTok(a){print("IfTok");var x,p=pos,c;if(x=tbl[p][152]){pos=x[1];a.push([p,152]);return 1}if(x==false){return 0}c=[];return fin(c,p,152,_IfTok(c),a)}
 function ElseTok(a){print("ElseTok");var x,p=pos,c;if(x=tbl[p][153]){pos=x[1];a.push([p,153]);return 1}if(x==false){return 0}c=[];return fin(c,p,153,_ElseTok(c),a)}
 function DoTok(a){print("DoTok");var x,p=pos,c;if(x=tbl[p][154]){pos=x[1];a.push([p,154]);return 1}if(x==false){return 0}c=[];return fin(c,p,154,_DoTok(c),a)}
 function WhileTok(a){print("WhileTok");var x,p=pos,c;if(x=tbl[p][155]){pos=x[1];a.push([p,155]);return 1}if(x==false){return 0}c=[];return fin(c,p,155,_WhileTok(c),a)}
 function ForTok(a){print("ForTok");var x,p=pos,c;if(x=tbl[p][156]){pos=x[1];a.push([p,156]);return 1}if(x==false){return 0}c=[];return fin(c,p,156,_ForTok(c),a)}
 function VarTok(a){print("VarTok");var x,p=pos,c;if(x=tbl[p][157]){pos=x[1];a.push([p,157]);return 1}if(x==false){return 0}c=[];return fin(c,p,157,_VarTok(c),a)}
 function ReturnTok(a){print("ReturnTok");var x,p=pos,c;if(x=tbl[p][158]){pos=x[1];a.push([p,158]);return 1}if(x==false){return 0}c=[];return fin(c,p,158,_ReturnTok(c),a)}
 function CaseTok(a){print("CaseTok");var x,p=pos,c;if(x=tbl[p][159]){pos=x[1];a.push([p,159]);return 1}if(x==false){return 0}c=[];return fin(c,p,159,_CaseTok(c),a)}
 function DefaultTok(a){print("DefaultTok");var x,p=pos,c;if(x=tbl[p][160]){pos=x[1];a.push([p,160]);return 1}if(x==false){return 0}c=[];return fin(c,p,160,_DefaultTok(c),a)}
 function SwitchTok(a){print("SwitchTok");var x,p=pos,c;if(x=tbl[p][161]){pos=x[1];a.push([p,161]);return 1}if(x==false){return 0}c=[];return fin(c,p,161,_SwitchTok(c),a)}
 function ThrowTok(a){print("ThrowTok");var x,p=pos,c;if(x=tbl[p][162]){pos=x[1];a.push([p,162]);return 1}if(x==false){return 0}c=[];return fin(c,p,162,_ThrowTok(c),a)}
 function CatchTok(a){print("CatchTok");var x,p=pos,c;if(x=tbl[p][163]){pos=x[1];a.push([p,163]);return 1}if(x==false){return 0}c=[];return fin(c,p,163,_CatchTok(c),a)}
 function FinallyTok(a){print("FinallyTok");var x,p=pos,c;if(x=tbl[p][164]){pos=x[1];a.push([p,164]);return 1}if(x==false){return 0}c=[];return fin(c,p,164,_FinallyTok(c),a)}
 function TryTok(a){print("TryTok");var x,p=pos,c;if(x=tbl[p][165]){pos=x[1];a.push([p,165]);return 1}if(x==false){return 0}c=[];return fin(c,p,165,_TryTok(c),a)}
 function WithTok(a){print("WithTok");var x,p=pos,c;if(x=tbl[p][166]){pos=x[1];a.push([p,166]);return 1}if(x==false){return 0}c=[];return fin(c,p,166,_WithTok(c),a)}
 ...
 function n(f){print("n");return function(){var p=pos,x=f([]);pos=p;return !x}}
 function p(f){print("p");return function(){var p=pos,x=f([]);pos=p;return x}}
 function t(a,n){if(a.length>n)a.splice(n)}
 function g(p){print("g");return str.charCodeAt(p)}
...
//var peg = require('./peg') ;
//if('require' in this) var print = require('sys').puts ;
//var posix = require('posix') ;

//posix.cat("./frameworks/runtime.js").addCallback(parse_and_show)

function show(indent){return function(array){
  print(indent + Program.names[array[0]] + ' length: ' + array[1])
  if(array[2]&&array[2].length)
    array[2].map(show(indent+'    '))}}

function parse_and_show(content) {
  var parse = Program(content) ;
  print(parse.toSource?parse.toSource():JSON.stringify(parse));
  print('\n\n---\n\n');
  show('')(parse[1])
//  print(JSON.stringify(parse,1)) ;
}

parse_and_show("var x;")
